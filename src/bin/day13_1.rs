...
fn main() {
    let dest = (31, 39);
    let fav_number = 1350;
    println!("{}", min_distance(dest, fav_number));
}
...
pub fn min_distance(goal: (usize, usize), fav_number: usize) -> usize {
...
mod tests {
    ...
    #[test]
    fn it_works() {
        assert_eq!(11, min_distance((7,4), 10));
    }
